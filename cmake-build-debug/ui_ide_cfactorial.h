...
public:
    ...
    void setupUi(QMainWindow *IDE_CFactorial)
    {
        ...
        IDE_CFactorial->resize(1022, 688);
        ...
        StdOut->setGeometry(QRect(10, 360, 991, 131));
        ...
        ApplicationLog->setGeometry(QRect(10, 530, 991, 131));
